...
void PlayerData::setupFooter() {
    ...
    QGridLayout* p1Layout = new QGridLayout(player1Data);
    p1Layout->setSpacing(0);
    QGridLayout* p2Layout = new QGridLayout(player2Data);
    ...
    *tankLightBlue = tankLightBlue->scaled(25, 25, Qt::KeepAspectRatio);
    ...
    p1Layout->addWidget(p1TankRed1, 1, 0);
    p1Layout->addWidget(p1TankRed1Percent, 1, 1);
